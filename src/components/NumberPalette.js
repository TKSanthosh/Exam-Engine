    ...
    <>
      <div className="row number-palette">
        {/* <div className="row"> */}
              ...
              <div className="col-md-4 row numbersection" style={{marginLeft: "0px"}}>
                ...
                {filteredQuestions && filteredQuestions.length > 0
                  ? filteredQuestions.map((filteredQuestion, index) => (
                      <button
                        ...
                        ${index === currentQuestionIndex - 1 ? "active" : ""} 
                        ${
                          answeredQuestions.includes(
                            filteredQuestion.display_order.toString()
                          ) &&
                          taggedQuestions.includes(filteredQuestion.display_order)
                            ? "taganswered"
                            : answeredQuestions.includes(
                                  filteredQuestion.display_order.toString()
                                )
