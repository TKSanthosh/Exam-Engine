...
import ManualQPUpload from "./ManualQPUpload";
            ...
            <tr key={rowIndex}>
              {row.map((report) => (
                ...
                <td key={report.id} onClick={() => {
                  type == 'miscellaneous' && [1,2,6,8,9,10,11,12].includes(report.id)
        ...
        <div className="popup">
          <div className="popup-content" style={{overflow:"auto"}}>
            ...
            {/* miscellaneous */}
                ...
                {types == 'miscellaneous' && selectedReport.id == 12 && <ManualQPUpload />}   
