                  ...
                  <tr key={option.id} className="option-row">
                    <td className="option-input-cell">
                      <input
                        ...
                        checked={selectedOption === option || answers[questionId] === value }
                            ...
                            <div className='footertab'>
                                <div className='row'>
                                    <div className='col-md-4'>
                                        ...
                                        <button className={`  ${currentQuestionIndex == 0 ? 'disabled-btn' : 'arrow btn-prev'}`} onClick={handleBackQuestion} disabled={currentQuestionIndex == 0} >Previous Question</button>                        
                                    ...
                                    <div className='col-md-4'>
                                    <button  className='tag-button' onClick={handleTagQuestion}>{tagquestions.includes(currentQuestionIndex + 1) ? "De-tag Question" : "Tag Question"}
                                    </button>
