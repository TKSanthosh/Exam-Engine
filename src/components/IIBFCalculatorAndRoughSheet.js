...
const IIBFCalculatorAndRoughSheet = ({ MembershipNo, QuestionPNo, SubjectCode, ExamDate, RoughtSheet }) => {
...
<div>
            ...
            {isVisible && (
                <div className="overlay">
                    {isCalculator ? (
                        <Draggable>
                        <div className="modal" style={{ backgroundColor: "transparent" }}>
...
export default IIBFCalculatorAndRoughSheet;
